...
namespace Unity.Services.Leaderboards.Models
{
    ...
    public class LeaderboardVersions
    {
        ...
        internal LeaderboardVersions(Internal.Models.LeaderboardVersions versions)
        {
            ...
            Results = versions.Results != null ? versions.Results.ConvertAll(v => new LeaderboardVersion(v)) : new List<LeaderboardVersion>();
            NextReset = versions.NextReset;
            VersionId = versions.VersionId;
            TotalArchivedVersions = versions.TotalArchivedVersions;
        }
