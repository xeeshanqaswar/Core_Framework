...
{
    /// <summary>
    /// AddLeaderboardPlayerScore400OneOf model
    /// </summary>
    [Preserve]
    [JsonConverter(typeof(AddLeaderboardPlayerScore400OneOfJsonConverter))]
    [DataContract(Name = "AddLeaderboardPlayerScore400OneOf")]
    internal class AddLeaderboardPlayerScore400OneOf : IOneOf
    {
        ...
        /// <summary>AddLeaderboardPlayerScore400OneOf Constructor</summary>
        /// <param name="value">The value as an object for AddLeaderboardPlayerScore400OneOf</param>
        /// <param name="type">The type for AddLeaderboardPlayerScore400OneOf</param>
        public AddLeaderboardPlayerScore400OneOf(object value, Type type)
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        /// <summary>
        /// Converts the JSON string into an instance of AddLeaderboardPlayerScore400OneOf
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of AddLeaderboardPlayerScore400OneOf</returns>
        public static AddLeaderboardPlayerScore400OneOf FromJson(string jsonString)
        {
            if (jsonString == null)
            {
                return null;
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("AddLeaderboardPlayerScore400OneOf", DiscriminatorKey);
                }
        ...
        private static AddLeaderboardPlayerScore400OneOf DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new AddLeaderboardPlayerScore400OneOf(actualObject, concreteType);
        }

        private static AddLeaderboardPlayerScore400OneOf DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new AddLeaderboardPlayerScore400OneOf(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for AddLeaderboardPlayerScore400OneOf to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class AddLeaderboardPlayerScore400OneOfJsonConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return AddLeaderboardPlayerScore400OneOf.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
        ...
        {
            return objectType == typeof(AddLeaderboardPlayerScore400OneOf);
        }
    }
}
