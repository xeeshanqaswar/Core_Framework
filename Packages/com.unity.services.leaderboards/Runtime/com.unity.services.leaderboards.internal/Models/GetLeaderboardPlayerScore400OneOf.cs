...
{
    /// <summary>
    /// GetLeaderboardPlayerScore400OneOf model
    /// </summary>
    [Preserve]
    [JsonConverter(typeof(GetLeaderboardPlayerScore400OneOfJsonConverter))]
    [DataContract(Name = "GetLeaderboardPlayerScore400OneOf")]
    internal class GetLeaderboardPlayerScore400OneOf : IOneOf
    {
        ...
        /// <summary>GetLeaderboardPlayerScore400OneOf Constructor</summary>
        /// <param name="value">The value as an object for GetLeaderboardPlayerScore400OneOf</param>
        /// <param name="type">The type for GetLeaderboardPlayerScore400OneOf</param>
        public GetLeaderboardPlayerScore400OneOf(object value, Type type)
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        /// <summary>
        /// Converts the JSON string into an instance of GetLeaderboardPlayerScore400OneOf
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of GetLeaderboardPlayerScore400OneOf</returns>
        public static GetLeaderboardPlayerScore400OneOf FromJson(string jsonString)
        {
            if (jsonString == null)
            {
                return null;
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("GetLeaderboardPlayerScore400OneOf", DiscriminatorKey);
                }
        ...
        private static GetLeaderboardPlayerScore400OneOf DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new GetLeaderboardPlayerScore400OneOf(actualObject, concreteType);
        }

        private static GetLeaderboardPlayerScore400OneOf DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new GetLeaderboardPlayerScore400OneOf(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for GetLeaderboardPlayerScore400OneOf to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class GetLeaderboardPlayerScore400OneOfJsonConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return GetLeaderboardPlayerScore400OneOf.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
        ...
        {
            return objectType == typeof(GetLeaderboardPlayerScore400OneOf);
        }
    }
}
