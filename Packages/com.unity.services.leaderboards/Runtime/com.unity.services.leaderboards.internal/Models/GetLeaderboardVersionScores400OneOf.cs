...
{
    /// <summary>
    /// GetLeaderboardVersionScores400OneOf model
    /// </summary>
    [Preserve]
    [JsonConverter(typeof(GetLeaderboardVersionScores400OneOfJsonConverter))]
    [DataContract(Name = "GetLeaderboardVersionScores400OneOf")]
    internal class GetLeaderboardVersionScores400OneOf : IOneOf
    {
        ...
        /// <summary>GetLeaderboardVersionScores400OneOf Constructor</summary>
        /// <param name="value">The value as an object for GetLeaderboardVersionScores400OneOf</param>
        /// <param name="type">The type for GetLeaderboardVersionScores400OneOf</param>
        public GetLeaderboardVersionScores400OneOf(object value, Type type)
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        /// <summary>
        /// Converts the JSON string into an instance of GetLeaderboardVersionScores400OneOf
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of GetLeaderboardVersionScores400OneOf</returns>
        public static GetLeaderboardVersionScores400OneOf FromJson(string jsonString)
        {
            if (jsonString == null)
            {
                return null;
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("GetLeaderboardVersionScores400OneOf", DiscriminatorKey);
                }
        ...
        private static GetLeaderboardVersionScores400OneOf DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new GetLeaderboardVersionScores400OneOf(actualObject, concreteType);
        }

        private static GetLeaderboardVersionScores400OneOf DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new GetLeaderboardVersionScores400OneOf(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for GetLeaderboardVersionScores400OneOf to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class GetLeaderboardVersionScores400OneOfJsonConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return GetLeaderboardVersionScores400OneOf.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
        ...
        {
            return objectType == typeof(GetLeaderboardVersionScores400OneOf);
        }
    }
}
