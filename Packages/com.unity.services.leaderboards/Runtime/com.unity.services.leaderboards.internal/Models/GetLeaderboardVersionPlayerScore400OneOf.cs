...
{
    /// <summary>
    /// GetLeaderboardVersionPlayerScore400OneOf model
    /// </summary>
    [Preserve]
    [JsonConverter(typeof(GetLeaderboardVersionPlayerScore400OneOfJsonConverter))]
    [DataContract(Name = "GetLeaderboardVersionPlayerScore400OneOf")]
    internal class GetLeaderboardVersionPlayerScore400OneOf : IOneOf
    {
        ...
        /// <summary>GetLeaderboardVersionPlayerScore400OneOf Constructor</summary>
        /// <param name="value">The value as an object for GetLeaderboardVersionPlayerScore400OneOf</param>
        /// <param name="type">The type for GetLeaderboardVersionPlayerScore400OneOf</param>
        public GetLeaderboardVersionPlayerScore400OneOf(object value, Type type)
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        /// <summary>
        /// Converts the JSON string into an instance of GetLeaderboardVersionPlayerScore400OneOf
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of GetLeaderboardVersionPlayerScore400OneOf</returns>
        public static GetLeaderboardVersionPlayerScore400OneOf FromJson(string jsonString)
        {
            if (jsonString == null)
            {
                return null;
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("GetLeaderboardVersionPlayerScore400OneOf", DiscriminatorKey);
                }
        ...
        private static GetLeaderboardVersionPlayerScore400OneOf DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new GetLeaderboardVersionPlayerScore400OneOf(actualObject, concreteType);
        }

        private static GetLeaderboardVersionPlayerScore400OneOf DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new GetLeaderboardVersionPlayerScore400OneOf(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for GetLeaderboardVersionPlayerScore400OneOf to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class GetLeaderboardVersionPlayerScore400OneOfJsonConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return GetLeaderboardVersionPlayerScore400OneOf.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
        ...
        {
            return objectType == typeof(GetLeaderboardVersionPlayerScore400OneOf);
        }
    }
}
