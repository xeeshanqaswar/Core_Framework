...
namespace Unity.Services.Leaderboards.Internal
{
    class LeaderboardsServiceInternal : ILeaderboardsService
    {
        ...
        public async Task<LeaderboardEntry> AddPlayerScoreAsync(string leaderboardId, double score, AddPlayerScoreOptions options = null)
        {
            LeaderboardEntry result = null;
            Response<Internal.Models.LeaderboardEntry> response;
            async Task AddPlayerScoreAsyncInternal()
            {
                response = await m_ApiClient.AddPlayerScoreAsync(leaderboardId, score, options?.Metadata, options?.VersionId);
        ...
        public async Task<LeaderboardScores> GetPlayerRangeAsync(string leaderboardId, GetPlayerRangeOptions options = null)
        {
            ...
            {
                response = await m_ApiClient.GetPlayerRangeAsync(leaderboardId, options?.RangeLimit, options?.IncludeMetadata);
        ...
        public async Task<LeaderboardEntry> GetPlayerScoreAsync(string leaderboardId, GetPlayerScoreOptions options = null)
        {
            LeaderboardEntry result = null;
            Response<Internal.Models.LeaderboardEntry> response;
            async Task GetPlayerScoreInternal()
            {
                response = await m_ApiClient.GetPlayerScoreAsync(leaderboardId, options?.IncludeMetadata);
                result = new LeaderboardEntry(response.Result);
            }
            ...
            List<string> playerIds, GetScoresByPlayerIdsOptions options = null)
        {
            ...
            {
                response = await m_ApiClient.GetScoresByPlayerIdsAsync(leaderboardId, playerIds, options?.IncludeMetadata);
        ...
        public async Task<LeaderboardScoresPage> GetScoresAsync(string leaderboardId, GetScoresOptions options = null)
        {
            ...
            {
                response = await m_ApiClient.GetScoresAsync(leaderboardId, options?.Offset, options?.Limit, options?.IncludeMetadata);
        ...
        public async Task<LeaderboardTierScoresPage> GetScoresByTierAsync(string leaderboardId, string tierId, GetScoresByTierOptions options = null)
        {
            ...
            {
                response = await m_ApiClient.GetScoresByTierAsync(leaderboardId, tierId, options?.Offset, options?.Limit, options?.IncludeMetadata);
        ...
        public async Task<LeaderboardVersionEntry> GetVersionPlayerScoreAsync(string leaderboardId, string versionId, GetVersionPlayerScoreOptions options = null)
        {
            ...
            {
                response = await m_ApiClient.GetVersionPlayerScoreAsync(leaderboardId, versionId, options?.IncludeMetadata);
            ...
            string versionId, GetVersionPlayerRangeOptions options = null)
        {
            ...
            {
                response = await m_ApiClient.GetVersionPlayerRangeAsync(leaderboardId, versionId, options?.RangeLimit, options?.IncludeMetadata);
        ...
        public async Task<LeaderboardVersionScoresPage> GetVersionScoresAsync(string leaderboardId, string versionId, GetVersionScoresOptions options = null)
        {
            ...
            {
                response = await m_ApiClient.GetVersionScoresAsync(leaderboardId, versionId, options?.Offset, options?.Limit, options?.IncludeMetadata);
        ...
        public async Task<LeaderboardVersionScoresWithNotFoundPlayerIds> GetVersionScoresByPlayerIdsAsync(
            string leaderboardId, string versionId, List<string> playerIds, GetVersionScoresByPlayerIdsOptions options = null)
        {
            ...
            {
                response = await m_ApiClient.GetVersionScoresByPlayerIdsAsync(leaderboardId, versionId, playerIds, options?.IncludeMetadata);
            ...
            string versionId, string tierId, GetVersionScoresByTierOptions options = null)
        {
            ...
            {
                response = await m_ApiClient.GetVersionScoresByTierAsync(leaderboardId, versionId, tierId, options?.Offset, options?.Limit, options?.IncludeMetadata);
        ...
        public async Task<LeaderboardVersions> GetVersionsAsync(string leaderboardId, GetVersionsOptions options = null)
        {
            ...
            {
                response = await m_ApiClient.GetVersionsAsync(leaderboardId, options?.Limit);
