...
namespace Unity.Services.Leaderboards.Authoring.Client.Models
{
    ...
    /// </summary>
    [Preserve]
    [DataContract(Name = "ValidationError_1")]
    internal class ValidationError1
    {
        /// <summary>
        /// Single error in the Validation Error Response.
        /// </summary>
        ...
        [Preserve]
        public ValidationError1(string field, List<string> messages)
        {
            Field = field;
            Messages = messages;
        }
        ...
        /// <summary>
        /// Parameter field of ValidationError1
        /// </summary>
        [Preserve]
        ...
        /// <summary>
        /// Parameter messages of ValidationError1
        /// </summary>
        [Preserve]
        ...
        /// <summary>
        /// Formats a ValidationError1 into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a ValidationError1 as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
