...
namespace Unity.Services.Leaderboards.Authoring.Client.Models
{
    ...
    /// </summary>
    [Preserve]
    [DataContract(Name = "LeaderboardConfig_2_tieringConfig")]
    internal class LeaderboardConfig2TieringConfig
    {
        /// <summary>
        /// Configuration for tiers to be applied to the Leaderboard.
        /// </summary>
        ...
        [Preserve]
        public LeaderboardConfig2TieringConfig(StrategyOptions strategy, List<LeaderboardConfig2TieringConfigTiers> tiers)
        {
            Strategy = strategy;
            Tiers = tiers;
        }
        ...
        /// <summary>
        /// Parameter tiers of LeaderboardConfig2TieringConfig
        /// </summary>
        [Preserve]
        [DataMember(Name = "tiers", IsRequired = true, EmitDefaultValue = true)]
        public List<LeaderboardConfig2TieringConfigTiers> Tiers{ get; }
        ...
        /// <summary>
        /// Formats a LeaderboardConfig2TieringConfig into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a LeaderboardConfig2TieringConfig as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
