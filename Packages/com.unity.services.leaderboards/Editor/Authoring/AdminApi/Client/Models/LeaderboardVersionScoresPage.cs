...
namespace Unity.Services.Leaderboards.Authoring.Client.Models
{
    ...
    internal class LeaderboardVersionScoresPage
    {
        ...
        [Preserve]
        public LeaderboardVersionScoresPage(LeaderboardVersion2 version = default, int offset = default, int limit = default, int total = default, List<object> results = default)
        {
            Version = version;
            Offset = offset;
            Limit = limit;
