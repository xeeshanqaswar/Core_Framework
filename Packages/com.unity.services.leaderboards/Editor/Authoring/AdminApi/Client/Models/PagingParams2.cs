...
namespace Unity.Services.Leaderboards.Authoring.Client.Models
{
    ...
    /// </summary>
    [Preserve]
    [DataContract(Name = "PagingParams_2")]
    internal class PagingParams2
    {
        /// <summary>
        /// Creates an instance of PagingParams2.
        /// </summary>
        /// <param name="offset">offset param</param>
        /// <param name="limit">limit param</param>
        /// <param name="total">total param</param>
        [Preserve]
        public PagingParams2(int offset = default, int limit = default, int total = default)
        {
            Offset = offset;
            Limit = limit;
            Total = total;
        ...
        /// <summary>
        /// Parameter offset of PagingParams2
        /// </summary>
        [Preserve]
        ...
        /// <summary>
        /// Parameter limit of PagingParams2
        /// </summary>
        [Preserve]
        ...
        /// <summary>
        /// Parameter total of PagingParams2
        /// </summary>
        [Preserve]
        ...
        /// <summary>
        /// Formats a PagingParams2 into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a PagingParams2 as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
