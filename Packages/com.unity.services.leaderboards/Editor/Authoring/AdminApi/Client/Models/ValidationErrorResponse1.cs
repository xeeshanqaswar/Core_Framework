...
namespace Unity.Services.Leaderboards.Authoring.Client.Models
{
    ...
    internal class ValidationErrorResponse1
    {
        /// <summary>
        /// Validation error response when a value provided from the client does notpass validation on server.
        /// </summary>
        ...
        [Preserve]
        public ValidationErrorResponse1(string type, string title, int status, int code, string detail, List<ValidationError1> errors, string instance = default)
        {
            Type = type;
            Title = title;
            Status = status;
        ...
        /// <summary>
        /// Parameter type of ValidationErrorResponse1
        /// </summary>
        [Preserve]
        ...
        /// <summary>
        /// Parameter title of ValidationErrorResponse1
        /// </summary>
        [Preserve]
        ...
        /// <summary>
        /// Parameter status of ValidationErrorResponse1
        /// </summary>
        [Preserve]
        ...
        /// <summary>
        /// Parameter code of ValidationErrorResponse1
        /// </summary>
        [Preserve]
        ...
        /// <summary>
        /// Parameter detail of ValidationErrorResponse1
        /// </summary>
        [Preserve]
        ...
        /// <summary>
        /// Parameter instance of ValidationErrorResponse1
        /// </summary>
        [Preserve]
        ...
        /// <summary>
        /// Parameter errors of ValidationErrorResponse1
        /// </summary>
        [Preserve]
        [DataMember(Name = "errors", IsRequired = true, EmitDefaultValue = true)]
        public List<ValidationError1> Errors{ get; }
    
        /// <summary>
        /// Formats a ValidationErrorResponse1 into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a ValidationErrorResponse1 as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
