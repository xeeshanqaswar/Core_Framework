...
{
    /// <summary>
    /// GetLeaderboardConfigs400ResponseOneOf model
    /// </summary>
    [Preserve]
    [JsonConverter(typeof(GetLeaderboardConfigs400ResponseOneOfJsonConverter))]
    [DataContract(Name = "GetLeaderboardConfigs400ResponseOneOf")]
    internal class GetLeaderboardConfigs400ResponseOneOf : IOneOf
    {
        ...
        /// <summary>GetLeaderboardConfigs400ResponseOneOf Constructor</summary>
        /// <param name="value">The value as an object for GetLeaderboardConfigs400ResponseOneOf</param>
        /// <param name="type">The type for GetLeaderboardConfigs400ResponseOneOf</param>
        public GetLeaderboardConfigs400ResponseOneOf(object value, Type type)
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        /// <summary>
        /// Converts the JSON string into an instance of GetLeaderboardConfigs400ResponseOneOf
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of GetLeaderboardConfigs400ResponseOneOf</returns>
        public static GetLeaderboardConfigs400ResponseOneOf FromJson(string jsonString)
        {
            if (jsonString == null)
            {
                return null;
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("GetLeaderboardConfigs400ResponseOneOf", DiscriminatorKey);
                }
        ...
        private static GetLeaderboardConfigs400ResponseOneOf DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new GetLeaderboardConfigs400ResponseOneOf(actualObject, concreteType);
        }

        private static GetLeaderboardConfigs400ResponseOneOf DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new GetLeaderboardConfigs400ResponseOneOf(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for GetLeaderboardConfigs400ResponseOneOf to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class GetLeaderboardConfigs400ResponseOneOfJsonConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return GetLeaderboardConfigs400ResponseOneOf.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
        ...
        {
            return objectType == typeof(GetLeaderboardConfigs400ResponseOneOf);
        }
    }
}
