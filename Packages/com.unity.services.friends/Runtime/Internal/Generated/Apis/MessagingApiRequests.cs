...
namespace Unity.Services.Friends.Internal.Generated.Messaging
{
    ...
    /// <summary>
    /// MessagingApiBaseRequest class
    /// </summary>
    [Preserve]
    internal class MessagingApiBaseRequest
    {
        /// <summary>
    ...
    /// </summary>
    [Preserve]
    internal class MessageRequest : MessagingApiBaseRequest
    {
        /// <summary>Accessor for messageRequestParameter </summary>
        [Preserve]
        public Unity.Services.Friends.Internal.Generated.Models.MessageRequest MessageRequestParameter { get; }
        ...
        /// Send a message to a user.
        /// </summary>
        /// <param name="messageRequestParameter">MessageRequest param</param>
        [Preserve]
        public MessageRequest(Unity.Services.Friends.Internal.Generated.Models.MessageRequest messageRequestParameter = default(Unity.Services.Friends.Internal.Generated.Models.MessageRequest))
        {
            MessageRequestParameter = messageRequestParameter;
            PathAndQueryParams = $"/v1/message";
        ...
        {
            if(MessageRequestParameter != null)
            {
                return ConstructBody(MessageRequestParameter);
            }
            return null;
        }
