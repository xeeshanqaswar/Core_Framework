...
namespace Unity.Services.Friends.Internal.Generated.Presence
{
    ...
    /// <summary>
    /// PresenceApiBaseRequest class
    /// </summary>
    [Preserve]
    internal class PresenceApiBaseRequest
    {
        /// <summary>
    ...
    /// </summary>
    [Preserve]
    internal class GetPresenceRequest : PresenceApiBaseRequest
    {
        ...
        /// <summary>
        /// GetPresence Request Object.
        /// Get presence for a user.
        /// </summary>
        /// <param name="userId">The userID.</param>
        [Preserve]
        public GetPresenceRequest(string userId)
        {
            UserId = userId;

            PathAndQueryParams = $"/v1/presence/{userId}";
    ...
    /// </summary>
    [Preserve]
    internal class SetPresenceRequest : PresenceApiBaseRequest
    {
        /// <summary>Accessor for presenceRequest </summary>
        [Preserve]
        public Unity.Services.Friends.Internal.Generated.Models.PresenceRequest PresenceRequest { get; }
        string PathAndQueryParams;

        /// <summary>
        /// SetPresence Request Object.
        /// Set presence for a user.
        /// </summary>
        /// <param name="presenceRequest">PresenceRequest param</param>
        [Preserve]
        public SetPresenceRequest(Unity.Services.Friends.Internal.Generated.Models.PresenceRequest presenceRequest = default(Unity.Services.Friends.Internal.Generated.Models.PresenceRequest))
        {
            PresenceRequest = presenceRequest;
            PathAndQueryParams = $"/v1/presence";
        ...
        public byte[] ConstructBody()
        {
            ...
            {
                return ConstructBody(PresenceRequest);
            }
            return null;
        }
