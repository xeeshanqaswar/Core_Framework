...
{
    /// <summary>
    /// Enumerates the known error causes when communicating with the Friends service.
    ...
    public enum FriendsErrorCode
    {
        ...
        /// <summary>
        /// Error parsing pagination limit
        /// </summary>
        RetrievePaginationLimit = 24004,

        /// <summary>
        /// The pagination limit must be a positive integer
        /// </summary>
        NegativePaginationLimit = 24005,

        /// <summary>
        /// Error parsing pagination offset
        /// </summary>
        RetrievePaginationOffset = 24006,

        /// <summary>
        /// The pagination offset must be a positive integer
        /// </summary>
        ...
        /// <summary>
        /// Failed to decode presence schema
        /// </summary>
        ...
        // 24400 - 24499
        /// <summary>
        /// Error code representing HTTP Status Code of 400 for the Friends service.
        /// The Friends service cannot process the request because it is invalid.
        /// </summary>
        BadRequest = 24400,

        // SDK specific error codes 24600-24699
        /// <summary>
        /// Error occurred with the connection to the notification system.
        /// </summary>
        ...
        /// <summary>
        /// Relationship not found in local storage
        /// </summary>
